...
const Navbar = () => {
  ...
  return (
    <nav className="flex bg-[#17171B] w-full h-[6rem]  top-0 left-0 shadow-md justify-between px-12 font-bold font-['Quicksand'] text-lg border-b-solid border-b  border-b-gray-700">
      ...
      <ul className='relative flex flex-grow mx-32 pl-3 gap-16 items-center  text-white '>
        ...
        <img src={mont} alt="" className='absolute h-2.5 left-4 bottom-0' />
      </ul>
